...
export const DICT = {
  ...
  */
  ...
  'xo.key': { zh: '密钥', en: 'Key' },
  'xo.keyPhHex': { zh: '密钥字节，如 41 42 或 4142', en: 'Key bytes, e.g. 41 42 or 4142' },
  'xo.keyPhText': { zh: '密钥文本，逐字符取 Latin-1 字节', en: 'Key text, one Latin-1 byte per character' },
  ...
  'tr.hint': { zh: '编码 = 文本按各编码转成字节；解码 = 把输入当字节（十六进制那半）或当默认编码的文本（另一半），再按各编码解回字符串。改动即时生效。', en: 'Encode turns the text into bytes under each encoding. Decode reads the input as bytes (the hex half) or as system-default text (the other half) and turns it back into a string under each encoding. Results update as you type.' },
  ...
  'tr.noRow': { zh: '这一组没有这一行', en: 'not produced for this group' },
  ...
  'ex.drop': { zh: '把文件拖到这里，或点一下选择', en: 'Drop a file here, or click to choose one' },
  'ex.dropAgain': { zh: '再拖一个文件进来可以换一份', en: 'Drop another file to replace this one' },
  'ex.in': { zh: '输入', en: 'In' },
  'ex.out': { zh: '输出', en: 'Out' },
