namespace WPE.InjectMode
{
    partial class InjectModeForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            menuItem21.Badge = "";
            menuItem21.BadgeBack = System.Drawing.Color.FromArgb(((int)(((byte)(22)))), ((int)(((byte)(119)))), ((int)(((byte)(255)))));
            menuItem21.IconSvg = "ProjectFilled";
            menuItem21.ID = "miPacketList";
            menuItem21.LocalizationText = "InjectModeForm.{id}";
            menuItem21.Select = true;
            menuItem21.Text = "封包列表";
            menuItem22.Badge = "";
            menuItem22.BadgeBack = System.Drawing.Color.FromArgb(((int)(((byte)(22)))), ((int)(((byte)(119)))), ((int)(((byte)(255)))));
            menuItem22.IconSvg = "FunnelPlotFilled";
            menuItem22.ID = "miFilterList";
            menuItem22.LocalizationText = "InjectModeForm.{id}";
            menuItem22.Text = "滤镜列表";
            menuItem23.Badge = "";
            menuItem23.BadgeBack = System.Drawing.Color.FromArgb(((int)(((byte)(22)))), ((int)(((byte)(119)))), ((int)(((byte)(255)))));
            menuItem23.IconSvg = "PlaySquareFilled";
            menuItem23.ID = "miSendList";
            menuItem23.LocalizationText = "InjectModeForm.{id}";
            menuItem23.Text = "发送列表";
            menuItem24.Badge = "";
            menuItem24.BadgeBack = System.Drawing.Color.FromArgb(((int)(((byte)(22)))), ((int)(((byte)(119)))), ((int)(((byte)(255)))));
            menuItem24.IconSvg = "RobotFilled";
            menuItem24.ID = "miRobotList";
            menuItem24.LocalizationText = "InjectModeForm.{id}";
            menuItem24.Text = "机器人列表";
            menuItem25.Badge = "";
            menuItem25.BadgeBack = System.Drawing.Color.FromArgb(((int)(((byte)(22)))), ((int)(((byte)(119)))), ((int)(((byte)(255)))));
            menuItem25.IconSvg = "PieChartFilled";
            menuItem25.ID = "miStatistical";
            menuItem25.LocalizationText = "InjectModeForm.{id}";
            menuItem25.Text = "统计数据";
            menuItem26.IconSvg = "SnippetsFilled";
            menuItem26.ID = "miComparison";
            menuItem26.LocalizationText = "InjectModeForm.{id}";
            menuItem26.Text = "文本对比";
            menuItem27.IconSvg = "CalculatorFilled";
            menuItem27.ID = "miXOR";
            menuItem27.LocalizationText = "InjectModeForm.{id}";
            menuItem27.Text = "异或计算";
            menuItem28.IconSvg = "BuildFilled";
            menuItem28.ID = "miTranscoding";
            menuItem28.LocalizationText = "InjectModeForm.{id}";
            menuItem28.Text = "编码转换";
            menuItem29.IconSvg = "SaveFilled";
            menuItem29.ID = "miExtraction";
            menuItem29.LocalizationText = "InjectModeForm.{id}";
            menuItem29.Text = "数据提取";
            menuItem30.Badge = "";
            menuItem30.BadgeBack = System.Drawing.Color.FromArgb(((int)(((byte)(22)))), ((int)(((byte)(119)))), ((int)(((byte)(255)))));
            menuItem30.IconSvg = "ContainerFilled";
            menuItem30.ID = "miSystemLog";
            menuItem30.LocalizationText = "InjectModeForm.{id}";
            menuItem30.Text = "系统日志";
            this.mInjectMode.Items.Add(menuItem21);
            this.mInjectMode.Items.Add(menuItem22);
            this.mInjectMode.Items.Add(menuItem23);
            this.mInjectMode.Items.Add(menuItem24);
            this.mInjectMode.Items.Add(menuItem25);
            this.mInjectMode.Items.Add(menuItem26);
            this.mInjectMode.Items.Add(menuItem27);
            this.mInjectMode.Items.Add(menuItem28);
            this.mInjectMode.Items.Add(menuItem29);
            this.mInjectMode.Items.Add(menuItem30);
            ...
            this.tabInjectMode.Style = styleLine3;
            ...
            this.tlpPacketList.Controls.Add(this.splitter, 0, 2);
            ...
            segmentedItem19.IconSvg = "FilterOutlined";
            segmentedItem19.Text = "过滤设置";
            ...
            segmentedItem20.IconSvg = "AimOutlined";
            segmentedItem20.Text = "拦截设置";
            ...
            segmentedItem21.IconSvg = "UnorderedListOutlined";
            segmentedItem21.Text = "列表设置";
            ...
            segmentedItem22.IconSvg = "GoldOutlined";
            segmentedItem22.Text = "快捷键";
            ...
            segmentedItem23.IconSvg = "DeliveredProcedureOutlined";
            segmentedItem23.Text = "备份设置";
            ...
            segmentedItem24.IconSvg = "SettingOutlined";
            segmentedItem24.Text = "系统设置";
            ...
            segmentedItem25.IconSvg = "SearchOutlined";
            segmentedItem25.Text = "查找封包";
            ...
            segmentedItem26.IconSvg = "DeleteOutlined";
            segmentedItem26.Text = "清空数据";
            ...
            segmentedItem27.IconSvg = "PlayCircleFilled";
            segmentedItem27.ID = "siStartHook";
            segmentedItem27.Text = "开始拦截";
            this.segmented.Items.Add(segmentedItem19);
            this.segmented.Items.Add(segmentedItem20);
            ...
            this.segmented.Items.Add(segmentedItem26);
            this.segmented.Items.Add(segmentedItem27);
            this.segmented.Location = new System.Drawing.Point(3, 3);
            this.segmented.Name = "segmented";
            this.segmented.Radius = 0;
            this.segmented.Size = new System.Drawing.Size(1118, 40);
            this.segmented.TabIndex = 3;
            this.segmented.SelectIndexChanged += new AntdUI.IntEventHandler(this.segmented_SelectIndexChanged);
            // 
            // splitter
            // 
            this.splitter.CollapsePanel = AntdUI.Splitter.ADCollapsePanel.Panel2;
            this.splitter.Cursor = System.Windows.Forms.Cursors.Default;
            this.splitter.Dock = System.Windows.Forms.DockStyle.Fill;
            this.splitter.Location = new System.Drawing.Point(3, 79);
            this.splitter.Name = "splitter";
            this.splitter.Orientation = System.Windows.Forms.Orientation.Horizontal;
            // 
            // splitter.Panel1
            // 
            this.splitter.Panel1.Controls.Add(this.tPacketList);
            this.splitter.Panel1MinSize = 0;
            // 
            // splitter.Panel2
            // 
            this.splitter.Panel2.Controls.Add(this.hbPacketData);
            this.splitter.Panel2MinSize = 0;
            this.splitter.Size = new System.Drawing.Size(1118, 612);
            this.splitter.SplitterDistance = 428;
            this.splitter.SplitterSize = 80;
            ...
            this.tPacketList.Size = new System.Drawing.Size(1118, 428);
            ...
            this.hbPacketData.Size = new System.Drawing.Size(1118, 174);
