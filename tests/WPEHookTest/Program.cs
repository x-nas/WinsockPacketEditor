...
namespace WPEHookTest
{
    ...
    internal static class Program
    {
        ...
        {
            if (args.Contains("--hookfix")) { return HookFix.Run(args); }
        ...
        private static unsafe void ClientScript(ushort tcpPort, ushort udpPort)
        {
            ...
            /*
                ...
                这是<b>改造前就有的老 bug，与 IPC 无关</b>。2.1.9 起 WinSockHook.StartHook
                在 64 位进程里<b>干脆不装</b>这个钩子（其余入口照常），所以产品不会再因它把目标弄崩；
                但 x64 上也就抓不到它了。要真修得给 WSARecvEx 单开一个钩子体 ——
