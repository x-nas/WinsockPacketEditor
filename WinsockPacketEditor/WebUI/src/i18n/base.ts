...
export const DICT = {
  ...
  */
  ...
  'cert.title': { zh: 'HTTPS 映射证书', en: 'HTTPS Mapping Certificate' },
  'cert.root': { zh: '根证书', en: 'Root certificate' },
  'cert.trusted': { zh: '当前用户已信任', en: 'Trusted for current user' },
  'cert.untrusted': { zh: '当前用户尚未信任', en: 'Not trusted for current user' },
  'cert.createHint': { zh: '尚未创建。添加并启用 HTTPS 本地映射后，请创建并信任此根证书。', en: 'Not created. After enabling an HTTPS local mapping, create and trust this root certificate.' },
  'cert.create': { zh: '创建根证书', en: 'Create root certificate' },
  'cert.trust': { zh: '信任', en: 'Trust' },
  'cert.untrust': { zh: '取消信任', en: 'Untrust' },
  'cert.delete': { zh: '删除材料', en: 'Delete material' },
  'cert.format': { zh: '导出格式', en: 'Export format' },
  'cert.export': { zh: '导出证书', en: 'Export certificate' },
  'cert.exported': { zh: '已导出：{0}', en: 'Exported: {0}' },
  'cert.error': { zh: 'HTTPS 映射证书操作失败', en: 'HTTPS mapping certificate operation failed' },
  'cert.result': { zh: '导出结果', en: 'Export result' },
  'cert.hint': { zh: '根证书仅信任到“当前用户”证书库；私钥材料由服务器级 Windows DPAPI 保护，不会包含在备份或导出中。除非手动删除材料，否则此服务器始终复用同一根证书。', en: 'The root is trusted only in the current-user store. Its private material is protected by server-level Windows DPAPI and is never included in backups or exports. This server reuses the same root unless you delete the material.' },
  'cert.formatCer': { zh: '.cer（通用）', en: '.cer (general)' },
  'cert.formatCrt': { zh: '.crt', en: '.crt' },
  'cert.formatDer': { zh: '.der', en: '.der' },
  'cert.formatPem': { zh: '.pem', en: '.pem' },
  'cert.formatAndroid': { zh: 'Android .0', en: 'Android .0' },
