...
namespace WPE.Lib.NativeMethods
{
    public class WS2_32
    {
        ...
        public static extern bool WSAGetOverlappedResult(
            Int32 Socket,
            ref Operate.PacketConfig.Packet.OVERLAPPED lpOverlapped,
        ...
        public static extern int getsockname(
            [In] int Socket, 
            [In, Out] ref Operate.PacketConfig.Packet.SockAddr Address, 
        ...
        public static unsafe Int32 SendHook(
            ...
            [In] SocketFlags Flags)
        {
            Operate.PacketConfig.Packet.PacketType ptType = Operate.PacketConfig.Packet.PacketType.WS2_Send;
        ...
        public static unsafe Int32 RecvHook(
            ...
            [In] SocketFlags Flags)
        {
            Operate.PacketConfig.Packet.PacketType ptType = Operate.PacketConfig.Packet.PacketType.WS2_Recv;
